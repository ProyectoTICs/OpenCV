...
bool Init()
{
	...
	if(!faceDetector.load("/usr/local/Cellar/opencv/2.4.9/share/OpenCV/haarcascades/haarcascade_frontalface_alt.xml"))
	{
	...
	if(!rEyeDetector.load("/usr/local/Cellar/opencv/2.4.9/share/OpenCV/haarcascades/haarcascade_eye_tree_eyeglasses.xml"))
	{
		cout << "No se encuentra el archivo haarcascade_eye_tree_eyeglasses.xml" << endl;
		return false;
	}
